...
export default function Model(props: JSX.IntrinsicElements['group']) {
    const { nodes, materials } = useGLTF(require("../../../../assets/3DModel/Fat_Character_Costume_1.glb")) as GLTFResult
...
useGLTF.preload(require("../../../../assets/3DModel/Fat_Character_Costume_1.glb"))