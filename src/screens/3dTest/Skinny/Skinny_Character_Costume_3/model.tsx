...
type GLTFResult = GLTF & {
    nodes: {
        ...
        Wolf3D_Outfit_Top004: THREE.Mesh
        Wolf3D_Outfit_Top005: THREE.Mesh
        Wolf3D_Outfit_Top006: THREE.Mesh
...
export default function Model(props: JSX.IntrinsicElements['group']) {
    const { nodes, materials } = useGLTF(require("../../../../assets/3DModel/Skinny_Character_Costume_3.glb")) as GLTFResult
...
useGLTF.preload(require("../../../../assets/3DModel/Skinny_Character_Costume_3.glb"))
