...
type GLTFResult = GLTF & {
    nodes: {
        ...
        Wolf3D_Outfit_Top007: THREE.Mesh
        Wolf3D_Outfit_Top008: THREE.Mesh
...
export default function Model(props: JSX.IntrinsicElements['group']) {
    const { nodes, materials } = useGLTF(require("../../../../assets/3DModel/Skinny_Character_Costume_2.glb")) as GLTFResult
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh
                castShadow
                receiveShadow
                geometry={nodes.Wolf3D_Outfit_Top007.geometry}
                material={materials['Wolf3D_Outfit_Footwear.002']}
            />
            <mesh
                castShadow
                receiveShadow
                geometry={nodes.Wolf3D_Outfit_Top008.geometry}
                material={materials['Wolf3D_Outfit_Footwear.002']}
            />
            <mesh
...
useGLTF.preload(require("../../../../assets/3DModel/Skinny_Character_Costume_2.glb"))
